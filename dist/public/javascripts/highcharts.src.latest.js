...
defaultOptions = {
	...
	symbols: ['circle', 'diamond', 'square', 'triangle', 'pointCircle', 'triangle-down'],
	lang: {
		loading: 'Loading...',
	...
	*/
	...
	shadow: function (shadowOptions, group, cutOff) {
		...
		if (shadowOptions) {
			...
			shadowElementOpacity = (shadowOptions.opacity || 0.07) / shadowWidth;
			transform = this.parentInverted ? 
				'(-1,-1)' : 
				'(' + pick(shadowOptions.offsetX, 0) + ', ' + pick(shadowOptions.offsetY, 6) + ')';
    	...
    	*/
        'pointCircle':function (x, y, w, h) {
            ...
            return [
                ...
                'Z',
                M, x1 + w1 / 2, y1,
                'C', x1 + w1 + cpw1, y1, x1 + w1 + cpw1, y1 + h1, x1 + w1 / 2, y1 + h1,
                'C', x1 - cpw1, y1 + h1, x1 - cpw1, y1, x1 + w1 / 2, y1,
                'Z'
            ];
        },
